...
/// Contains data from the response body of the Neocities' `/api/key` endpoint.
#[derive(Default, Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct ApiKey {
    /// A status message
    pub result: String,
    /// The API key generated by the Neocities server to a specific registered user
    #[serde(rename = "api_key")]
    pub api_key: String,
}

/// Prepares and sens a request for a key to the Neocities API. It awaits a response and returns a
/// Result of a ApiKey or an error.
#[tokio::main]
